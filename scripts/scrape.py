...
if(len(missing_coords)>0):  
    ...
    backup = save_updated_json(locations_cache, f'{WORKING_DIRECTORY}/backups/locations.json')
...
response = requests.post(url, headers=headers, json={"events":final, "token":APP_API_KEY})
